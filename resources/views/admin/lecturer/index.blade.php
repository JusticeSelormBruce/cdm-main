...
@section('render')
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row">
            ...
            @if($data == null)
                <form action="/admin/assign-subjects" method="post">
                    <div class="row">
                        <div class="mx-auto w-50">
                                ...
                                <div class="row py-2">
                                    @foreach($subject as $list)
                                        <div class="col-4 input-group-sm ">
                                            <input type="checkbox" name="subject_id[]" value="{{$list->id}}"
                                                   class="mx-3 py-2">
                                            <span>{{$list->name}}</span>
                                        </div>
                                    @endforeach
                            ...
                            <div class="design input-group-sm py-2">
                                ...
                                <div class="row py-2">
                                    @foreach($subject as $list)
                                        <div class="col-4 input-group-sm ">
                                            <input type="checkbox" name="subject_id[]" value="{{$list->id}}"
                                                   class="mx-3 py-2" @foreach($subjectRoles as $roles) @if($list->id ==$roles) checked @endif @endforeach> <span>{{$list->name}}</span>
                                        </div>
                                    @endforeach
